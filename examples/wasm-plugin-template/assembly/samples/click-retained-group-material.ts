import {
  ...
  BUTTON_RIGHT,
  EVENT_KIND_CLICK,
  GROUP_MATERIAL_FEEDBACK_MODE_SWIRL,
  GROUP_MATERIAL_STYLE_SOFT_BLOOM_LIKE,
  ...
  UPSERT_GROUP_MATERIAL_COMMAND_BYTES_WITH_FULL_TAILS,
  ...
  writeUpsertGroupMaterialWithFullTails,
...
const GROUP_ID: u32 = 7920;
const GLOW_ID: u32 = 7921;
const SPRITE_ID: u32 = 7922;
const PARTICLE_ID: u32 = 7923;
const TRAIL_ID: u32 = 7924;
const FIELD_ID: u32 = 7925;
...
const MATERIAL_BYTES: u32 = UPSERT_GROUP_MATERIAL_COMMAND_BYTES_WITH_FULL_TAILS;
