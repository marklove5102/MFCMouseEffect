...
- macOS input permission degraded notice restart-copy correction: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zzp9-macos-input-permission-degraded-notice-hot-recovery-copy.md`
...
- macOS effects compute/registry ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56ze-macos-effects-compute-registry-objcxx-prune.md`
- macOS overlay-coord ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zf-macos-overlay-coord-objcxx-prune.md`
- macOS ObjC++ allowlist compiler-probe prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zg-macos-objcxx-allowlist-compiler-probe-prune.md`
- macOS effects plan/state ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zh-macos-effects-plan-state-objcxx-prune.md`
- macOS WASM plan/layout ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zi-macos-wasm-plan-layout-objcxx-prune.md`
...
- macOS hold update ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zu-macos-hold-update-objcxx-prune.md`
- macOS scroll core wrapper ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zv-macos-scroll-core-wrapper-objcxx-prune.md`
- macOS trail core wrapper ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zw-macos-trail-core-wrapper-objcxx-prune.md`
- macOS click core wrapper ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zx-macos-click-core-wrapper-objcxx-prune.md`
...
- macOS overlay render-support ObjC++ prune: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zzc-macos-overlay-render-support-objcxx-prune.md`
- macOS hover overlay Swift bridge cutover: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zzd-macos-hover-overlay-swift-bridge-cutover.md`
- macOS click overlay Swift bridge cutover: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zze-macos-click-overlay-swift-bridge-cutover.md`
- macOS scroll overlay Swift bridge cutover: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zzf-macos-scroll-overlay-swift-bridge-cutover.md`
- macOS trail overlay Swift bridge cutover: `/Users/sunqin/study/language/cpp/code/MFCMouseEffect/docs/refactoring/phase56zzg-macos-trail-overlay-swift-bridge-cutover.md`
