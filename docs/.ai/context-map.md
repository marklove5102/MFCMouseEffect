...
Generated: 2026-03-24T02:08:31.402Z
...
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~16910 tok
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~15992 tok
...
- `docs/ops/manual-commands.md` -> ~6651 tok
- `docs/agent-context/current.md` -> ~5903 tok
