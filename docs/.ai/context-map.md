...
Generated: 2026-03-21T14:55:14.388Z
...
- `docs/architecture/windows-mouse-companion-phase1-plan.md` -> ~4497 tok
- `docs/automation/gesture-matching.md` -> ~4462 tok
- `docs/architecture/mouse-companion-3d-runtime-blueprint.zh-CN.md` -> ~3937 tok
- `docs/agent-context/current.md` -> ~3397 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~3377 tok
