...
Generated: 2026-03-23T05:51:40.339Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~12921 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~10767 tok
...
- `docs/agent-context/current.md` -> ~4401 tok
