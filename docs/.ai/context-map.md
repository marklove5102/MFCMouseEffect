...
Generated: 2026-03-24T02:18:42.787Z
...
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~16991 tok
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~16023 tok
...
- `docs/ops/manual-commands.md` -> ~6682 tok
- `docs/agent-context/current.md` -> ~5918 tok
