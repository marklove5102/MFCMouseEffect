...
Generated: 2026-03-23T04:14:04.634Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~12568 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~10513 tok
...
- `docs/agent-context/current.md` -> ~4281 tok
