...
Generated: 2026-03-22T02:35:40.570Z
...
- `docs/architecture/windows-mouse-companion-phase1-plan.md` -> ~7360 tok
- `docs/architecture/custom-effects-wasm-route.zh-CN.md` -> ~6872 tok
- `docs/architecture/custom-effects-wasm-route.md` -> ~6707 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~6653 tok
- `docs/agent-context/current.md` -> ~6318 tok
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~6281 tok
