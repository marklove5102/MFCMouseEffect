...
Generated: 2026-03-22T00:29:32.073Z
...
- `docs/architecture/windows-mouse-companion-phase1-plan.md` -> ~5428 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~4759 tok
- `docs/automation/gesture-matching.md` -> ~4462 tok
- `docs/agent-context/current.md` -> ~4282 tok
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~4044 tok
