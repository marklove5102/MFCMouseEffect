...
Generated: 2026-03-23T09:07:25.998Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~14318 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~13309 tok
...
- `docs/agent-context/current.md` -> ~4792 tok
- `docs/ops/manual-commands.md` -> ~4775 tok
