...
Generated: 2026-03-23T10:04:18.872Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~14731 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~14502 tok
...
- `docs/ops/manual-commands.md` -> ~5162 tok
- `docs/agent-context/current.md` -> ~4965 tok
