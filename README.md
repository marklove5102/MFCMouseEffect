...
- ⌨️ **输入指示器** — 鼠标点击、滚轮方向、键盘组合键可视化，`Cmd+Tab`、`W+ x3` 一目了然
...
<table>
  <tr>
    <td align="center"><img src="./docs/images/placeholder_input_indicator.png" width="360" alt="输入指示器"><br><b>输入指示器</b></td>
    <td align="center"><img src="./docs/images/placeholder_automation_mapping.png" width="360" alt="自动化映射"><br><b>自动化映射</b></td>
  </tr>
</table>

- **输入指示器** — 把鼠标点击、滚轮方向、键盘组合键一起展示出来，`L x2`、`W+ x3`、`Cmd+Tab` 这类信息在录屏和演示里更直观
...
| 方向 | 说明 | 入口 |
|:---|:---|:---|
| 🎨 **新视觉效果** | 新的点击、拖尾、悬停样式设计 | [效果文档](./docs/README.zh-CN.md) |
| 🔌 **WASM 插件** | 编写新插件或完善工具链 | [插件模板](./examples/wasm-plugin-template/README.md) |
| 🖥️ **跨平台对齐** | Windows / macOS 行为一致性 | [Issue Tracker](https://github.com/sqmw/MFCMouseEffect/issues) |
| 🌐 **WebSettings** | 设置页体验优化 | [WebUI 源码](./MFCMouseEffect/WebUIWorkspace/) |
