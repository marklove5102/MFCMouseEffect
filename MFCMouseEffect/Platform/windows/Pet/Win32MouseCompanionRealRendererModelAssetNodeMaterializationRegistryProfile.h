...
struct Win32MouseCompanionRealRendererModelAssetNodeMaterializationProfile;
struct Win32MouseCompanionRealRendererModelNodeBindingProfile;
struct Win32MouseCompanionRealRendererSceneRuntime;
struct Win32MouseCompanionRealRendererScene;

struct Win32MouseCompanionRealRendererModelAssetNodeMaterializationRegistryProfile final {
    uint32_t entryCount{0};
    uint32_t resolvedEntryCount{0};
    float materializationRegistryWeight{0.0f};
    std::string materializationRegistryState{"preview_only"};
