...
Win32MouseCompanionRealRendererAssetNodeJointHintEntry BuildJointHintEntry(
    ...
    const Win32MouseCompanionRealRendererAssetNodeMatchResolveEntry& matchResolveEntry) {
