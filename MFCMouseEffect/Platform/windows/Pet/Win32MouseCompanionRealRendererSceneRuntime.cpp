...
Win32MouseCompanionRealRendererSceneRuntime BuildWin32MouseCompanionRealRendererSceneRuntime(
    ...
    sceneRuntime.modelAssetNodeProjectionProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeProjectionProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeProjectionRegistryProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeProjectionRegistryProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeRealizationProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeRealizationProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeRealizationRegistryProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeRealizationRegistryProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeMaterializationProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeMaterializationProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeMaterializationRegistryProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeMaterializationRegistryProfile(sceneRuntime);
    sceneRuntime.modelAssetNodePresentationProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodePresentationProfile(sceneRuntime);
    sceneRuntime.modelAssetNodePresentationRegistryProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodePresentationRegistryProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeVisibilityProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeVisibilityProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeVisibilityRegistryProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeVisibilityRegistryProfile(sceneRuntime);
    sceneRuntime.modelAssetNodePresenceProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodePresenceProfile(sceneRuntime);
    sceneRuntime.modelAssetNodePresenceRegistryProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodePresenceRegistryProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeOccupancyProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeOccupancyProfile(sceneRuntime);
    sceneRuntime.modelAssetNodeOccupancyRegistryProfile =
        BuildWin32MouseCompanionRealRendererModelAssetNodeOccupancyRegistryProfile(sceneRuntime);
