...
struct Win32MouseCompanionRealRendererModelAssetInstanceProfile;
struct Win32MouseCompanionRealRendererSceneRuntime;
struct Win32MouseCompanionRealRendererScene;

struct Win32MouseCompanionRealRendererModelAssetActivationProfile final {
    uint32_t entryCount{0};
    uint32_t resolvedEntryCount{0};
    float activationWeight{0.0f};
    std::string activationState{"preview_only"};
