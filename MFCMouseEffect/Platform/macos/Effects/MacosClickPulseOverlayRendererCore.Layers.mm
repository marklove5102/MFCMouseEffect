...
void ConfigureClickPulseBaseLayer(
    ...
    base.fillColor = [ClickPulseFillColor(button, profile) CGColor];
    base.strokeColor = [ClickPulseStrokeColor(button, profile) CGColor];
...
void AddClickPulseExtraLayers(
    ...
    if (plan.starMode) {
        ...
        star.fillColor = [ClickPulseStrokeColor(button, profile) CGColor];
        star.strokeColor = [ClickPulseStrokeColor(button, profile) CGColor];
    ...
    if (plan.textMode) {
        ...
        text.foregroundColor = [ClickPulseStrokeColor(button, profile) CGColor];
