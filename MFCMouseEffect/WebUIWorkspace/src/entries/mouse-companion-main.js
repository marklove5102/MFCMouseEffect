...
function writeRuntimeDiagnostics(runtimeState) {
  ...
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_session_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_session_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_session_session_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_session_session_brief,
      'action:idle|reactive:idle|follow:0|drag:0|hold:0|scroll:0|pose:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_bind_ready_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_bind_ready_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_bind_ready_binding_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_bind_ready_binding_brief,
  ...
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_lift_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_lift_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_lift_lift_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_lift_lift_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_bind_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_bind_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_bind_bind_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_bind_bind_brief,
  ...
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_command_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_command_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_command_command_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_command_command_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_controller_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_controller_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_controller_controller_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_controller_controller_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_driver_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_driver_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_driver_driver_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_driver_driver_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_driver_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_driver_registry_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_driver_registry_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_driver_registry_registry_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_consumer_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_consumer_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_consumer_consumer_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_consumer_consumer_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_consumer_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_consumer_registry_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_consumer_registry_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_consumer_registry_registry_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_projection_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_projection_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_projection_projection_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_projection_projection_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_projection_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_projection_registry_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_projection_registry_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_projection_registry_registry_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_realization_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_realization_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_realization_realization_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_realization_realization_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_realization_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_realization_registry_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_realization_registry_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_realization_registry_registry_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_materialization_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_materialization_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_materialization_materialization_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_materialization_materialization_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_materialization_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_materialization_registry_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_materialization_registry_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_materialization_registry_registry_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
  ...
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_visibility_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_visibility_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_visibility_visibility_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_visibility_visibility_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_visibility_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_visibility_registry_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_visibility_registry_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_visibility_registry_registry_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_presence_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_presence_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_presence_presence_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_presence_presence_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_presence_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_presence_registry_brief,
      'preview_only/0/0',
    ),
  );
  writeTextValue(
    'mc_runtime_scene_runtime_model_asset_node_presence_registry_registry_brief',
    normalizeRuntimeText(
      runtimeState.renderer_runtime_scene_runtime_model_asset_node_presence_registry_registry_brief,
      'body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only',
    ),
  );
  writeTextValue(
