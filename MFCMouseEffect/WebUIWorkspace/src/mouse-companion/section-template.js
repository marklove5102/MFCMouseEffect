  ...
  return `
    ...
    <details class="mouse-companion-details" open>
      ...
      <div class="grid">
        ...
        <label>Model Asset Node Realization</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_realization_brief">-</output>

        <label>Model Node Realization</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_realization_realization_brief">-</output>

        <label>Model Asset Node Realization Registry</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_realization_registry_brief">-</output>
        ...
        <label>Model Asset Node Presentation</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_presentation_brief">-</output>

        <label>Model Node Presentation</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_presentation_presentation_brief">-</output>

        <label>Model Asset Node Presentation Registry</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_presentation_registry_brief">-</output>

        <label>Model Node Presentation Registry</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_presentation_registry_registry_brief">-</output>

        <label>Model Asset Node Visibility</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_visibility_brief">-</output>

        <label>Model Node Visibility</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_visibility_visibility_brief">-</output>

        <label>Model Asset Node Visibility Registry</label>
        <output id="mc_runtime_scene_runtime_model_asset_node_visibility_registry_brief">-</output>
