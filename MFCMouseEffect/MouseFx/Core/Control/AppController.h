...
public:
    ...
    struct MouseCompanionRuntimeStatus {
        ...
        std::string rendererRuntimeSceneRuntimeModelAssetNodeConsumerRegistryValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeProjectionState{"preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeProjectionEntryCount{0};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeProjectionResolvedEntryCount{0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeProjectionBrief{
            "preview_only/0/0"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeProjectionProjectionBrief{
            "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeProjectionValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeProjectionRegistryState{
            "preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeProjectionRegistryEntryCount{0};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeProjectionRegistryResolvedEntryCount{0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeProjectionRegistryBrief{
            "preview_only/0/0"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeProjectionRegistryRegistryBrief{
            "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        ...
        std::string rendererRuntimeSceneRuntimeModelAssetNodeMaterializationRegistryValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresentationState{
            "preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodePresentationEntryCount{0};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodePresentationResolvedEntryCount{0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresentationBrief{
            "preview_only/0/0"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresentationPresentationBrief{
            "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresentationValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresentationRegistryState{
            "preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodePresentationRegistryEntryCount{0};
        uint32_t
            rendererRuntimeSceneRuntimeModelAssetNodePresentationRegistryResolvedEntryCount{0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresentationRegistryBrief{
            "preview_only/0/0"};
        std::string
            rendererRuntimeSceneRuntimeModelAssetNodePresentationRegistryRegistryBrief{
                "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresentationRegistryValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityState{
            "preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeVisibilityEntryCount{0};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeVisibilityResolvedEntryCount{0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityBrief{
            "preview_only/0/0"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityVisibilityBrief{
            "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityRegistryState{
            "preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeVisibilityRegistryEntryCount{0};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodeVisibilityRegistryResolvedEntryCount{
            0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityRegistryBrief{
            "preview_only/0/0"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityRegistryRegistryBrief{
            "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodeVisibilityRegistryValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresenceState{
            "preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodePresenceEntryCount{0};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodePresenceResolvedEntryCount{0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresenceBrief{
            "preview_only/0/0"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresencePresenceBrief{
            "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresenceValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresenceRegistryState{
            "preview_only"};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodePresenceRegistryEntryCount{0};
        uint32_t rendererRuntimeSceneRuntimeModelAssetNodePresenceRegistryResolvedEntryCount{
            0};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresenceRegistryBrief{
            "preview_only/0/0"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresenceRegistryRegistryBrief{
            "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
        std::string rendererRuntimeSceneRuntimeModelAssetNodePresenceRegistryValueBrief{
            "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
