...
struct PetVisualHostRendererRuntimeDiagnostics {
    ...
    std::string sceneRuntimeModelAssetSourceBrief{"preview_only/unknown/runtime_only"};
    std::string sceneRuntimeModelAssetSourcePathBrief{
        "model:-|actions:-|appearance:-"};
    std::string sceneRuntimeModelAssetSourceValueBrief{
        "model:0|actions:0|appearance:0|format:0"};
    ...
    std::string sceneRuntimeModelAssetManifestEntryBrief{
        "model:model|actions:actions|appearance:appearance"};
    std::string sceneRuntimeModelAssetManifestValueBrief{
        "model:0|actions:0|appearance:0|weight:0.00"};
    ...
    std::string sceneRuntimeModelAssetCatalogEntryBrief{
        "model:-|action:-|appearance:default"};
    std::string sceneRuntimeModelAssetCatalogValueBrief{
    ...
    std::string sceneRuntimeModelAssetBindingTableSlotBrief{
    ...
    std::string sceneRuntimeModelAssetNodeDriverRegistryValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodeConsumerState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodeConsumerEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodeConsumerResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodeConsumerBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodeConsumerConsumerBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodeConsumerValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodeConsumerRegistryState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodeConsumerRegistryEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodeConsumerRegistryResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodeConsumerRegistryBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodeConsumerRegistryRegistryBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodeConsumerRegistryValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodeProjectionState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodeProjectionEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodeProjectionResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodeProjectionBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodeProjectionProjectionBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodeProjectionValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodeProjectionRegistryState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodeProjectionRegistryEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodeProjectionRegistryResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodeProjectionRegistryBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodeProjectionRegistryRegistryBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodeProjectionRegistryValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodeRealizationState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodeRealizationEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodeRealizationResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodeRealizationBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodeRealizationRealizationBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodeRealizationValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodeRealizationRegistryState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodeRealizationRegistryEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodeRealizationRegistryResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodeRealizationRegistryBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodeRealizationRegistryRegistryBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    ...
    std::string sceneRuntimeModelAssetNodeMaterializationRegistryValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodePresentationState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodePresentationEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodePresentationResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodePresentationBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodePresentationPresentationBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodePresentationValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodePresentationRegistryState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodePresentationRegistryEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodePresentationRegistryResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodePresentationRegistryBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodePresentationRegistryRegistryBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    ...
    std::string sceneRuntimeModelAssetNodeVisibilityRegistryValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodePresenceState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodePresenceEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodePresenceResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodePresenceBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodePresencePresenceBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodePresenceValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
    std::string sceneRuntimeModelAssetNodePresenceRegistryState{"preview_only"};
    uint32_t sceneRuntimeModelAssetNodePresenceRegistryEntryCount{0};
    uint32_t sceneRuntimeModelAssetNodePresenceRegistryResolvedEntryCount{0};
    std::string sceneRuntimeModelAssetNodePresenceRegistryBrief{"preview_only/0/0"};
    std::string sceneRuntimeModelAssetNodePresenceRegistryRegistryBrief{
        "body:stub|head:stub|appendage:stub|overlay:stub|grounding:stub|adapter:runtime_only"};
    std::string sceneRuntimeModelAssetNodePresenceRegistryValueBrief{
        "body:0.00|head:0.00|appendage:0.00|overlay:0.00|grounding:0.00|adapter:0.00"};
